...
void usage_libary::ShowRsaUsage() {
    ...
    std::cout << "" << std::endl;
    std::cout << "    " << Mark(" 4") << ". " << Hint("RSA Generate X509 CA Certificate:") << std::endl;
    std::cout << Info("        [-rsa | --rsa] [-gen | -generate] -ca <size> [--subject] -ku [--key-usage] [-out | -output] [--keys-way]") << std::endl;
    std::cout << "" << std::endl;
    std::cout << "    " << Mark(" 5") << ". " << Hint("RSA Export Parameters from Public Key & Private Key:") << std::endl;
    ...
    std::cout << "" << std::endl;
    std::cout << "    " << Mark(" 6") << ". " << Hint("RSA Export Public Key & Private Key from Parameters:") << std::endl;
    ...
    std::cout << "" << std::endl;
    std::cout << "    " << Mark(" 7") << ". " << Hint("RSA Extract Public Key from Private Key:") << std::endl;
    ...
    std::cout << "" << std::endl;
    std::cout << "    " << Mark("15") << ". " << Hint("RSA Signed Data:") << std::endl;
    ...
    std::cout << "" << std::endl;
    std::cout << "    " << Mark("16") << ". " << Hint("RSA Verify Data:") << std::endl;
