...
$DER_Y=""
$DER_X="A6B35FB22B7F62948DA4BC2E25D9B26FF1A6DC9055D1A5A4D3EB8FF2"
$DER_P=""
$DER_Q="A951A601352144A5D0AD0EF595CFF3898DAFBD85EE975B65F0BAD527"
$DER_G=""
...
function DSA_Export_Keys_PEM {
    ...
    .\aisio -dsa -export -key -param "$BASE" -y "$DER_Y" -x "$DER_X" -p "$DER_P" -q "$DER_Q" -g "$DER_G" -dp -out -pem
}

function DSA_Export_Keys_DER {
    Write-Host "Ais DSA Export Keys DER..."
    .\aisio -dsa -export -key -param "$BASE" -y "$DER_Y" -x "$DER_X" -p "$DER_P" -q "$DER_Q" -g "$DER_G" -dp -out -der "$BASE"
}
